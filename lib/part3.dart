      ...
      body: Container(
        ...
        child: AnimatedBuilder(
          ...
          builder: (_, child) {
            ...
            double radio = 150;
            double x = radio * sin(pi * 2 * animation.value / 360) + size.width / 2;
                  ...
                  child: Container(
                    ...
                    child: Cube(
                      onSceneCreated: (Scene scene) {
                        ...
                        scene.world.add(Object(fileName: 'assets/images/3d/pigeon.obj', scale: Vector3(7.0, 7.0, 7.0)));
                      },
                    ),
                  ),
                ),
...
class MyLightPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Path pathLines = Path()
    ..addRect(Rect.fromLTWH(-widthScreen / 2, -heightScreen / 2, widthScreen * 2, heightScreen * 2))
